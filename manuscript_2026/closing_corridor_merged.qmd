...
![The 2020 extrapolations and what the new data showed. Rows: Norway, United States. Left column: the 2020-vintage data (repository tag `demres-2020`), re-rendered in the current visual specification, with the 2020-era speculative extrapolations in magenta, digitized from the September 2018 working figure (Supplement S7); they appear on the 2020-vintage panels only. Right column: the 2026 update. Heavy contour: CPCFR = 2.05 (replacement); thin: 1.50. Contours escaping through the top mark cohorts that never reach the milestone; contours cut at the data edge are censored.](figures/forecast_check_2x2.png){#fig-2x2}
